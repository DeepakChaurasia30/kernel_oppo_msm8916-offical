...
int set_cabc(int level)
{
	...
	if(!(is_project(OPPO_15009)||is_project(OPPO_15037)||is_project(OPPO_15035)||is_project(OPPO_15029)||is_project(OPPO_15109)||is_project(OPPO_15399))){
		return 0;
	}
	pr_err("%s : %d \n",__func__,level);
...
/* YongPeng.Yi@SWDP.MultiMedia, 2015/03/23  Add for 15009 modify +-5v timing START */
			if(lcd_dev !=LCD_15399_BOE_ILI9881C){
				if (gpio_is_valid(ctrl_pdata->disp_en_gpio))
...
/* YongPeng.Yi@SWDP.MultiMedia END */
#endif /*VENDOR_EDIT*/
		}else if(LCD_15399_BOE_ILI9881C == lcd_dev){
			gpio_set_value((ctrl_pdata->rst_gpio), 0);
			gpio_free(ctrl_pdata->rst_gpio);
			mdelay(2);
			...
			#ifdef VENDOR_EDIT
			//lile@EXP.BasicDrv.LCD, 2016-03-17, add for 15399 Tianma LCD mipi power off timing test, T15>100ms
			mdelay(100);
			#endif
			if (gpio_is_valid(ctrl_pdata->bklt_en_gpio)) {
				gpio_set_value((ctrl_pdata->bklt_en_gpio), 0);
...
/* YongPeng.Yi@SWDP.MultiMedia, 2015/05/29  Add for 15009 cabc START */
		if((is_project(OPPO_15009)||is_project(OPPO_15037)||is_project(OPPO_15035)||is_project(OPPO_15029)||is_project(OPPO_15109)||is_project(OPPO_15399)) && ctrl->ndx==0){
			set_backlight_pwm(1);
...
/* wuyu@EXP.BaseDrv.LCM, 2015-05-18, add micro OPPO_15011, (OPPO15011=OPPO_15018) */
/*huqiao@EXP.BasicDrv.Basic add for clone 15085*/
	if(MSM_BOOT_MODE__NORMAL!=get_boot_mode() && (is_project(OPPO_15011) || is_project(OPPO_15018) || is_project(OPPO_15022) || is_project(OPPO_15085) || is_project(OPPO_15035) || is_project(OPPO_15009) || is_project(OPPO_15029) || is_project(OPPO_15109) || is_project(OPPO_15399))){
		pinfo->esd_check_enabled = false;
	}
#endif /*VENDOR_EDIT*/
...
/* <- YongPeng.Yi@SWDP.MultiMedia, 2015/06/11  Add for 15037 read reg START */
			if((lcd_dev == LCD_15037_TRULY_HX8389C)||(lcd_dev == LCD_15035_TM_OTM9605)||(lcd_dev == LCD_15069_TM_OTM9605A)||(lcd_dev == LCD_15035_TRULY_HX8389C) || is_project(OPPO_15029) || is_project(OPPO_15109)){
...
/* Xiaori.Yuan@Mobile Phone Software Dept.Driver, 2014/07/28  Add for lcd acl and hbm mode */
	...
	if(is_project(OPPO_15029) || is_project(OPPO_15109) || is_project(OPPO_15399)){
...
/* YongPeng.Yi@SWDP.MultiMedia, 2015/06/11  Add for lcd type START */
	...
	}else if(!strcmp(panel_name,"oppo15399tm nt35521s 720p video mode dsi panel")){/*rongchun.zhang the next two panel need compatible*/
...
/* wuyu@EXP.BaseDrv.LCM, 2015-07-23, add TE check for 15070 */
		...
		if((MSM_BOOT_MODE__FACTORY == get_boot_mode())&&(is_project(OPPO_15009)||is_project(OPPO_15037)||is_project(OPPO_15035)||is_project(OPPO_15029)||is_project(OPPO_15109)||is_project(OPPO_15399))){
			ESD_TE_TEST = 0;
		}
