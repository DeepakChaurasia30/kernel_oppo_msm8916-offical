...
/* lile@EXP.BasicDrv.LCD, 2016-06-25, Add for ftm sleep current too big */
...
/*huqiao@EXP.BasicDrv.Basic add for clone 15085*/
			{
				if(!(is_project(OPPO_14045) || is_project(OPPO_15011) ||is_project(OPPO_15009) || is_project(OPPO_15037) ||
					is_project(OPPO_15085) || is_project(OPPO_15035) || is_project(OPPO_15018) || is_project(OPPO_15022) || is_project(OPPO_15109) || is_project(OPPO_15399)) || panel_dead){
					panel_dead = false;
					//mdss_fb_set_backlight(mfd, mfd->unset_bl_level);
