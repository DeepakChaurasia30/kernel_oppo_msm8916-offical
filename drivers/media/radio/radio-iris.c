	...
	unsigned long param)
{
	...
	/*zengling.wu@EXP.BaseDrv.Audio, 2016-04-06, add for 15399 FM*/
	else if(is_project(OPPO_15029) || is_project(OPPO_15109)  || is_project(OPPO_15399)) //lile@EXP.BasicDrv.Audio, 2015-11-16, add for 15309 FM
	{
		defRmssi = 256 - 64;
	}
