...
/*chaoying.chen@EXP.BaseDrv.LCM,2015/07/14 modify  ftm for 15085 at sleep */
	if(get_boot_mode() == MSM_BOOT_MODE__FACTORY && (is_project(OPPO_15011) || is_project(OPPO_15018) || is_project(OPPO_15022) || is_project(OPPO_15035) || is_project(OPPO_15037) || is_project(OPPO_15085) || is_project(OPPO_15399))){
