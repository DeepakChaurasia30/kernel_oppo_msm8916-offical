...
CC		= $(shell, which python2) $(srctree)/scripts/gcc-wrapper.py $(REAL_CC)
...
#Added by Fuchun.Liao@Mobile.BSP.Charge 2015-11-27 add for alarm debug
ifeq ($(SPECIAL_OPPO_CONFIG),1)
KBUILD_CFLAGS += -DCONFIG_AGING_TEST_ALARM_DEBUG
endif
